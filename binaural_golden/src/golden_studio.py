...
REFACTORING FOR RASPBERRY PI 5:
================================
This file has been partially refactored for Pi5 deployment (Issue #5).

COMPLETED:
- ✓ AudioEngine extracted to core/audio_engine.py (~430 lines removed)
- ✓ studio/ module created with audio_manager.py (for future use)
- ✓ Imports now use core.audio_engine instead of internal definition

TODO (Future work):
- [ ] Extract Tab classes to ui/ (BinauralTab, SpectralTab, etc.)
- [ ] Create preset_manager.py for preset handling
- [ ] Create session_manager.py for session management
- [ ] Move theme/styling to separate module

File reduced from 4083 lines to ~3600 lines as first refactoring step.
"""
...
# ══════════════════════════════════════════════════════════════════════════════
# AUDIO ENGINE - IMPORTED FROM CORE MODULE (REFACTORED FOR PI5)
# ══════════════════════════════════════════════════════════════════════════════
# NOTE: AudioEngine was extracted from this file to core/audio_engine.py
# This import replaces the ~430 line AudioEngine class that was here
# ══════════════════════════════════════════════════════════════════════════════

try:
    from core.audio_engine import AudioEngine
    print("✓ Using modular AudioEngine from core/audio_engine.py")
except ImportError as e:
    print(f"⚠️ Could not import AudioEngine from core/: {e}")
    print("⚠️ Please ensure core/audio_engine.py is available")
    import sys
    sys.exit(1)
